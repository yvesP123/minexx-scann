...
const ExportPage = () => {
  ...
  useEffect(() => {
    const getExport = async () => {
      try {
        const response = await fetch(`https://minexx-api-scann.vercel.app/exportnoauth/${id}`,
          {
            method:'GET',
            headers:
            {
        ...
        const companyResponse = await fetch(`https://minexx-api-scann.vercel.app/companiesnoAuth/${company_id}`,
          {
            method:'GET',
            headers:
            {
        ...
        //for documentation
        const companyDocResponse = await fetch(`https://minexx-api-scann.vercel.app/documentsnoAuth/${company_id}`,
          {
            method:'GET',
            headers:
            {
        ...
        //for shareholder
        const shareholderResponse = await fetch(`https://minexx-api-scann.vercel.app/shareholdersnoAuth/${company_id}`,
          {
            method:'GET',
            headers:
            {
        ...
        //for beneficial
        const beneficialResponse = await fetch(`https://minexx-api-scann.vercel.app/ownersnoAuth/${company_id}`,
          {
            method:'GET',
            headers:
            {
        ...
        const CompanyMineResponse = await fetch(`https://minexx-api-scann.vercel.app/companiesMine`,
          {
            method:'GET',
          });
        ...
        //For Mine tab owner
        const CompanyMineownerResponse = await fetch(`https://minexx-api-scann.vercel.app/ownersMine`,
          {
            method:'GET',
          });
        ...
        const CompanyMineDocResponse = await fetch(`https://minexx-api-scann.vercel.app/documentsMine`,
          {
            method:'GET',
          });
        ...
        //For Mine Shareholer
        const CompanyMineShareResponse = await fetch(`https://minexx-api-scann.vercel.app/shareholdersMine`,
          {
            method:'GET',
          });
    ...
    const fetMinesite=async()=>
    {
      try {
        ...
        const response=await fetch(`https://minexx-api-scann.vercel.app/minesnoauth`,
          {
            method:'GET'
          });
          if (!response.ok) {
    ...
    const fetchAssessmentData = async (minesite_id) => {
      try {
        const response = await fetch(`https://minexx-api-scann.vercel.app/assessments/mines/${minesite_id}`);
        if (!response.ok) {
          throw new Error('Network response was not ok');
        }
        const data = await response.json();
